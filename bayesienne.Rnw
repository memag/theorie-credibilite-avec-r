...
Dans l'approche bayésienne, l'opinion a priori d'un individu sur la
...
La prime bayésienne de l'exemple \ref{ex:bayesienne:bernoulli-beta}
...
\begin{exemple}[Cas Poisson/gamma]
  ...
  \item Calculer la prime bayésienne à partir de la distribution a
    posteriori de $\Theta$.
...
\Opensolutionfile{reponses}[reponses-bayésienne]
\Opensolutionfile{solutions}[solutions-bayésienne]
...
\begin{exercice}
  ...
  \begin{sol}
    ...
    = 5$.  Le calcul de la prime bayésienne requiert la distribution a
    posteriori de $\Theta$:
    \begin{align*}
...
\begin{exercice}
  ...
  \begin{sol}
    ...
    \item Comme la distribution a posteriori est de même famille que
      la distribution a priori, la prime bayésienne est de la même
